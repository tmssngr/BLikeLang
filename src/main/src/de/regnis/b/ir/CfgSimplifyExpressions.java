 ...
 */
public final class CfgSimplifyExpressions {

	// Static =================================================================

	public static void transform(@NotNull ControlFlowGraph graph) {
		final CfgSimplifyExpressions transformation = new CfgSimplifyExpressions();
	...
	private void handleBlock(AbstractBlock block) {
		switch (block) {
			case BasicBlock basicBlock -> basicBlock.replace((statement, consumer) -> statement.visit(new SimpleStatementVisitor<>() {
				@Override
