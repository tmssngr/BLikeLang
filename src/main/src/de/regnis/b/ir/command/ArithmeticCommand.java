 ...
 */
final class ArithmeticCommand extends Command {
	...
	public ArithmeticCommand(@NotNull Operation operation, @NotNull String name, int constant) {
	...
	public ArithmeticCommand(@NotNull Operation operation, @NotNull String name, @NotNull String sourceVar) {
		this.operation = operation;
		this.name = name;
		constant = 0;
	...
	public boolean equals(Object obj) {
		...
		final ArithmeticCommand that = (ArithmeticCommand) obj;
