...
public class BrilToAsmTest {
	...
	public void testLoop() {
		Assert.assertEquals(new BrilAsm()
				                    ...
				                    .bstoreToStack(BrilVarMapping.A_REGISTER, BrilVarMapping.FP_REGISTER, 0)
									//.branch("cond", "exit", "body")
				                    .bloadFromStack(BrilVarMapping.A_REGISTER, BrilVarMapping.FP_REGISTER, 0)
				                    ...
				                    .istoreToStack(BrilVarMapping.A_REGISTER, BrilVarMapping.FP_REGISTER, 2)
									//.id("a", "b")
				                    .iload(BrilVarMapping.VAR0_REGISTER, BrilVarMapping.VAR1_REGISTER)
									//.id("b", "sum")
				                    .iloadFromStack(BrilVarMapping.VAR1_REGISTER, BrilVarMapping.FP_REGISTER, 2)
				                    //.constant("one", 1)
				                    .iconst(BrilVarMapping.VAR2_REGISTER, 1)
				                    //.sub("n", "n", "one")
