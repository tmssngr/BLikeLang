...
public interface BLikeLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link BLikeLangParser#declaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaration(BLikeLangParser.DeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BLikeLangParser#constantDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstantDefinition(BLikeLangParser.ConstantDefinitionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitEmptyStatement(BLikeLangParser.EmptyStatementContext ctx);
	/**
